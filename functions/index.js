...
const addingitem = require("./addingItem.js")
...
function processV1Request(request, response) {
  ...
  const actionHandlers = {
    ...
    'HRA': () => {
      ...
      addingitem(parameters)
      sendResponse(" Your infos: " +
        "  - company: " + parameters["company"] +
        " - type: " + parameters["type"] +
        " - Register Number: " + parameters["regNr"] + 
        " - Register Court:  " + parameters ["regCourt"] + 
        " - your name:   " + parameters ["regCourt"] +
        " - your email: " + parameters["email"]);
